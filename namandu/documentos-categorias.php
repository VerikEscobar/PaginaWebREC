...
<body class="<?php include 'menu-class.php';?> fixed-layout">
    ...
    window.accionesFila = {
        'click .cambiar-estado': function(e, value, row, index) {
            ...
            swal({
                ...
                $.ajax({
                    url: 'inc/documentos-categorias-data?q=cambiar-estado',
                    type: 'post',
                    data: { id: row.id_documento_categoria, estado: status },
                    beforeSend: function() {
                        NProgress.start();
                    },
                    success: function(datos, textStatus, jQxhr) {
                        ...
                        if (n == -1) {
                            ...
                            $('#tabla').bootstrapTable('refresh', { url: 'inc/documentos-categorias-data?q=ver' });
                        } else {
                            swal.close();
        ...
        'click .editar': function(e, value, row, index) {
            ...
            $("#hidden_id").val(row.id_documento_categoria);
            ...
            $('#eliminar').click(function() {
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        async: false,
                        type: 'POST',
                        url: 'inc/documentos-categorias-data',
                        cache: false,
    ...
    $("#tabla").bootstrapTable({
        ...
        sortName: "id_documento_categoria",
        sortOrder: 'asc',
        height: $(window).height() - 90,
        pageSize: Math.floor(($(window).height() - 90) / 50),
        columns: [
            [
                { field: 'id_documento_categoria', align: 'center', valign: 'middle', title: 'ID', sortable: true, visible: false },
    ...
    $("#formulario").submit(function(e) {
        ...
        $.ajax({
            url: 'inc/documentos-categorias-data?q=' + $(this).attr("action"),
            dataType: 'html',
            type: 'post',
