...
<body class="<?php include 'menu-class.php';?> fixed-layout">
                        ...
                        <div id="toolbar">
                            <div class="form-inline" role="form">
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary" id="agregar" data-toggle="modal" data-target="#modal_principal">Agregar Descripcion</button>
                                </div>
                            </div>
                        </div>
                        <table id="tabla" data-url="inc/footercargar-data?q=ver" data-toolbar="#toolbar" data-show-export="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search-align="right" data-buttons-align="right" data-toolbar-align="left" data-pagination="false" data-classes="table table-hover table-condensed" data-striped="true" data-icons="icons" data-show-fullscreen="true"></table>
                        <!-- MODA PRINCIPAL -->
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <input class="form-control input-sm" type="text" name="descripcion" id="descripcion" autocomplete="off" required>
                                                </div>
                                            </div>
                                        </div>
    ...
    window.accionesFila = {
        'click .cambiar-estado': function(e, value, row, index) {
            ...
            swal({
                ...
                $.ajax({
                    url: 'inc/footercargar-data?q=cambiar-estado',
                    type: 'post',
                    data: { id: row.id_footer, estado: status },
                    beforeSend: function() {
                        NProgress.start();
                    },
                    success: function(datos, textStatus, jQxhr) {
                        ...
                        if (n == -1) {
                            ...
                            $('#tabla').bootstrapTable('refresh', { url: 'inc/footercargar-data?q=ver' });
                        } else {
                            swal.close();
            ...
            $('#eliminar').click(function() {
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        async: false,
                        type: 'POST',
                        url: 'inc/footercargar-data',
                        cache: false,
                        data: { q: 'eliminar', id: $("#hidden_id").val(), descripcion: descripcion },
                        beforeSend: function() {
    ...
    $("#tabla").bootstrapTable({
        ...
        sortName: "f.id_footer",
        sortOrder: 'asc',
        height: $(window).height() - 90,
        pageSize: Math.floor(($(window).height() - 90) / 50),
        columns: [
            [
                { field: 'id_footer', align: 'center', valign: 'middle', title: 'ID', sortable: true, visible: false },
                { field: 'descripcion', align: 'left', valign: 'middle', title: 'Descripción', sortable: true },
    ...
    $('#agregar').click(function() {
        $('#modalLabel').html('Agregar Descripcion Footer');
    ...
    $("#formulario").submit(function(e) {
        ...
        $.ajax({
            url: 'inc/footercargar-data?q=' + $(this).attr("action"),
            dataType: 'html',
            type: 'post',
