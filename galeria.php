<?php 
$title       = "Galería | Registro del Estado Civil";
...
if (!empty($_GET['desde']) && !empty($_GET['hasta'])) {
    ...
    header("location:" . url() . "galerias/desde/$d/hasta/$h");
}
?>
    ...
    <section class="blog-page-section sec-padding">
        <div class="contenedor2">
            ...
            <div class="row">
                <div class="col-md-3 right-box" style="margin-bottom:1rem;">
                    <div class="single-sidebar-widget mb-2">
                        <div class="search-widget contenedor">
                            <form>
                                <input type="text" class="form-control" name="buscar" placeholder="Buscar Galería">
                ...
                <div class="col-md-9">
                    <?php 
                     include 'inc/galeria-data.php';
                     traerGaleria($pag, 12, $buscar, $desde, $hasta);
                    ?>
                </div>
            </div>
        </div>
