<?php 
$title       = "Trámites en Oficina Central | Registro del Estado Civil";
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group row">
                        <div class="col-sm-6 centrito">
                            <h3>Trámites y Requisitos</h3>
                        </div>
                        <div class="col-sm-6 space">
                            <div style="margin-bottom: 1rem;">
                                <ul class="lista-tramites espacito">
                                    <li><i class="fa fa-address-book text-white" aria-hidden="true"></i><i class="fa fa-address-book" aria-hidden="true"></i><a class="blan" href="mas-informacion"><button class="btn colorsito">Informaciones Útiles</button></a></li>
                                    <li><i class="fa fa-address-book" aria-hidden="true"></i><a class="blan" href="tarifas"><button class="btn colorsito">Tarifas</button></a></li>
                                    <!--<li><i class="fa fa-address-book" aria-hidden="true"></i><a class="blan" href="formularios"><button class="btn colorsito">Formularios</button></a></li>-->
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div id="accordion" class="panel-group">
                                <?php include 'inc/tramites-data.php'; ?>
                            </div>
                        </div>
                    </div>
                </div>
